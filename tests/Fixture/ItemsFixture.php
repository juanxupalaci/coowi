...
class ItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descripcion' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'fecha' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'estado' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'fk_contiene' => ['type' => 'index', 'columns' => ['idpeticion'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['iditem'], 'length' => []],
            'fk_contiene' => ['type' => 'foreign', 'columns' => ['idpeticion'], 'references' => ['peticiones', 'idpeticion'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
